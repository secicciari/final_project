...
CREATE TABLE weather_scaled_updated (
	winery TEXT NOT NULL,
	country TEXT NOT NULL,
	points INT,
	variety TEXT,
...
CREATE TABLE winery_weather_updated (
	winery TEXT NOT NULL,
	avg_temp NUMERIC NOT NULL,
	avg_airp NUMERIC NOT NULL,
	avg_humid NUMERIC NOT NULL,
...
CREATE TABLE uscounty_weather_v2 (
	zip INT NOT NULL,
	lat INT NOT NULL,
	lng INT NOT NULL,
	city TEXT,
...
SELECT * FROM weather_scaled_updated;
SELECT * FROM winery_weather_updated;
SELECT * FROM uscounty_weather_v2;
